      ...
      <Layout>
        ...
        <section className="container py-5">
          <div className="d-flex gap-2 gap-md-5 align-items-center container">
            ...
            <p>
              <button onClick={resetFilters} className="btn btn-info text-white">Reset Filters</button>
            </p>
          </div>
          {!isLoading && jobs.length < 1 && <Empty height={'200'} content= {'No job fits your Search'} />} 
